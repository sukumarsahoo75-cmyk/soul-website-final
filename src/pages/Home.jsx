  ...
  return (
    <Layout>
      <div className="bg-black text-white font-sans">
        ...
        {/* --- 3. CUSTOM GIFT SET BANNER (UPDATED) --- */}
        <div className="relative min-h-[550px] flex items-center justify-center px-4 text-center border-b border-gray-800 overflow-hidden group">
           ...
           {/* Background Image - costume.jpg */}
           <img 
             src="/images/costume.jpg" 
             // Fallback image if costume.jpg is missing
             ...
             className="absolute inset-0 w-full h-full object-cover opacity-100 transition duration-1000 group-hover:scale-105 group-hover:opacity-70"
           />
