...
export const products = [
  ...
  { 
    ...
    inStock: true,
    description: "A gorgeous gardenia-based floral Perfume that feels like a spring garden in full bloom. Cheerful, pear-sweetened, and beautifully feminine.",
    inspiration: "A floral masterpiece comparable to Guc*i Flora.",
    notes: { top: "Pear, Red Berries", mid: "Gardenia, Frangipani", base: "Patchouli, Brown Sugar" },
    specs: { gender: "Female", weather: "Spring/Summer", time: "Daytime", longevity: "12+ Hours", projection: "1.5-2 Hours" },
    rating: 0, reviews: []
  },
  { 
    ...
    inspiration: "Shares the addictive coffee-vanilla DNA of YS* Black Opium.",
  ...
  { 
    ...
    inStock: true,
    description: "The Perfume of freedom. A bold floral fragrance blending French lavender with Moroccan orange blossom for a unique floral-musk fusion.",
    inspiration: "A bold floral structure reminiPerfume of Y*L Libre.",
  ...
  { 
    ...
    inStock: true,
    description: "A powerful aromatic vanilla Perfume. Three distinct vanillas wrapped in bright lavender create a warm, glowing aura.",
    inspiration: "Captures the golden vanilla allure of Burbe*ry Goddess.",
  ...
  { 
    ...
    inspiration: "Reflects the golden intensity of JPG L* Male Elixir.",
  ...
  { 
    ...
    inspiration: "Inspired by the spicy freshness of Dior S@uvage Elixir.",
  ...
  { 
    ...
    inspiration: "A cozy, romantic vibe similar to Arm@ni Stronger With You.",
  ...
  { 
    ...
    inStock: true,
    description: "The quintessential ocean Perfume. A wave of mint and sea water nuances that feels like a dive into the deep blue.",
    inspiration: "The classic aquatic freshness of D@vidoff Cool Water.",
  ...
  { 
    ...
    inspiration: "Comparable to the iconic T@m Ford Oud Wood.",
  ...
  { 
    ...
    inStock: true,
    description: "A dark, chypre oriental Perfume. Black truffle and floral notes collide with earthiness for a gothic, sexy mystery.",
    inspiration: "A dark floral experience like Tom F@rd Noir de Noir.",
  ...
  { 
    ...
    inspiration: "Shares the sweet, spicy DNA of L@ttafa Khamrah.",
  ...
  { 
    ...
    inspiration: "A coffee-forward twist similar to Kh@mrah Qahwa.",
  ...
  { 
    ...
    inStock: true,
    description: "The ocean during a storm. Dark, salty, and incredibly powerful. This is a marine Perfume for those who want to be noticed.",
    inspiration: "Captures the nuclear aquatic power of Ort@ Parisi Megamare.",
  ...
  { 
    ...
    inspiration: "A fruity explosion reminiPerfume of Xerj@ff Erba Pura.",
  ...
  { 
    ...
    inspiration: "Comparable to the iconic T@m Ford Tobacco Vanille.",
  ...
  { 
    ...
    inspiration: "Inspired by the legendary B@ccarat Rouge 540.",
  ...
  { 
    ...
    inStock: true,
    description: "Pure imagination. A clean, soapy, and citrusy tea Perfume that feels like Apparel hotel soap in the best way possible.",
    inspiration: "A fresh citrus tea Perfume similar to LV Im@gination.",
  ...
  { 
    ...
    inspiration: "Inspired by the raw elegance of T@m Ford Ombre Leather.",
  ...
  { 
    ...
    inStock: true,
    description: "Comforting and warm. The smoky, woodsy Perfume of a crackling fire combined with the sweet, cozy aroma of roasting chestnuts.",
    inspiration: "Captures the cozy warmth of Maison Margiela Replic@ By the Fireplace.",
